...
public class AdminDao {
    ...
    private static final String MATCH_ADMIN_SQL="SELECT COUNT(*) FROM user where admin_id = ? and password = ? ";
    private static final String RE_PASSWORD_SQL="UPDATE user set password = ? where admin_id = ? ";
    private static final String GET_PASSWD_SQL="SELECT password from user where admin_id = ?";
